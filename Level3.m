function[]= Level3(source,eventdata)
global ah q
...
set(s([12 19]), 'Facecolor', 'g')
set(s([46 48]), 'Facecolor', 'm')
set(s([23 35]), 'Facecolor', 'y')
set(s([22 50]), 'Facecolor', 'b')
set(s([11 18]), 'Facecolor', 'r')
set(s([4 25]), 'Facecolor', 'c')
set(s([8 33]), 'Facecolor', [.2 .6 .8])
